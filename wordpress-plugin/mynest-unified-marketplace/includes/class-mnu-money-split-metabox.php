	...
	public static function render( $post_or_order ): void {
		...
		<div class="mnu-ms">
			<table>
				...
				<tr class="mnu-ms-sub"><td>&nbsp;&nbsp;of which platform <?php echo esc_html( (string) (int) round( tnm_fee_percent() ) ); ?>%</td><td class="mnu-ms-val"><?php echo esc_html( self::money( $data['platform_fee_cents'] ) ); ?></td></tr>
