	...
	public static function mark_verified( int $user_id, string $source = 'link' ): void {
		...
		if ( function_exists( 'tnm_notify' ) ) {
			tnm_notify(
				...
				__( 'Thanks for verifying your email address. Save a bank account in the mobile app; earnings become payout-eligible after the 7-day holding window, then you can request an ACH payout.', 'mynest-unified-marketplace' ),
				0,
				'',
